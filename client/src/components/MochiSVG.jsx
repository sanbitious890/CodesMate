    ...
    >
      ...
      <defs>
        ...
        <radialGradient id="coreGlow" cx="50%" cy="50%" r="50%">
          ...
          <stop offset="50%" stopColor="#FF6B8A" stopOpacity="0.4" />
        ...
        <radialGradient id="eyeGlow" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="60%" stopColor="#2D1B3D" />
          <stop offset="100%" stopColor="#1A0F2E" />
        </radialGradient>

        {/* Body Shadow */}
        <filter id="shadow">
          <feDropShadow dx="0" dy="4" stdDeviation="8" floodColor="#FFD6E7" floodOpacity="0.3"/>
        </filter>
      ...
      >
        ...
        <circle cx="85" cy="100" r="12" fill="#FFFFFF" opacity="0.6" />
        <circle cx="115" cy="100" r="12" fill="#FFFFFF" opacity="0.6" />
        <circle cx="100" cy="95" r="15" fill="#FFFFFF" opacity="0.5" />
        ...
        >
          <path
            d="M155 115 Q175 105 170 85 Q165 75 160 80"
            stroke="#FFF5F7"
            strokeWidth="12"
            fill="none"
            strokeLinecap="round"
        ...
        <motion.g
          animate={{
            rotate: state === 'tilt' ? 8 : state === 'confused' ? -5 : 0,
          }}
        ...
        >
          ...
          >
            {/* Left Eye */}
            <g>
              <ellipse cx="78" cy="60" rx="14" ry="16" fill="#FFFFFF" />
              <ellipse cx="78" cy="60" rx="9" ry="11" fill="url(#eyeGlow)" />
              <circle cx="75" cy="56" r="4.5" fill="#FFFFFF" opacity="0.9" />
              <circle cx="82" cy="64" r="2" fill="#FFFFFF" opacity="0.5" />
              <circle cx="84" cy="58" r="1.5" fill="#FFFFFF" opacity="0.3" />
            </g>

            {/* Right Eye */}
            <g>
              <ellipse cx="122" cy="60" rx="14" ry="16" fill="#FFFFFF" />
              <ellipse cx="122" cy="60" rx="9" ry="11" fill="url(#eyeGlow)" />
              <circle cx="119" cy="56" r="4.5" fill="#FFFFFF" opacity="0.9" />
              <circle cx="126" cy="64" r="2" fill="#FFFFFF" opacity="0.5" />
              <circle cx="128" cy="58" r="1.5" fill="#FFFFFF" opacity="0.3" />
            </g>
          </motion.g>

          {/* ===== EXPRESSIONS ===== */}
          
          {/* Happy Eyes (Closed & Curved Up) */}
          {expression === 'happy' && (
            <motion.g
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          {expression === 'confused' && (
            ...
            >
              ...
              <path d="M70 68 Q78 62 86 68" stroke="#2D1B3D" strokeWidth="1.5" fill="none" />
              <path d="M114 72 Q122 66 130 72" stroke="#2D1B3D" strokeWidth="1.5" fill="none" />
            </motion.g>
          )}
          ...
          <motion.path
            d={
              ...
              expression === 'surprised' ? 'M93 80 Q100 90 107 80' :
          ...
          >
            ...
            <path
              d="M96 123 Q98 119 100 121 Q102 119 104 123 Q100 127 96 123Z"
              fill="#FFFFFF"
              opacity="0.8"
            />
          </motion.g>
          ...
          <motion.g
            animate={{
              rotate: state === 'happy' ? [0, 5, 0] : 0,
            }}
            transition={{ duration: 1, repeat: state === 'happy' ? Infinity : 0 }}
          >
            {/* Left Wing */}
            <path
              d="M45 110 Q30 95 35 80 Q40 70 45 75 Q40 85 45 100"
              fill="#FFD6E7"
              opacity="0.4"
            />
            <path
              d="M45 110 Q35 100 38 90 Q42 85 45 90 Q42 98 45 105"
              fill="#FFB6C1"
              opacity="0.3"
            />
            ...
            {/* Right Wing */}
            <path
              d="M155 110 Q170 95 165 80 Q160 70 155 75 Q160 85 155 100"
              fill="#FFD6E7"
              opacity="0.4"
            />
            <path
              d="M155 110 Q165 100 162 90 Q158 85 155 90 Q158 98 155 105"
              fill="#FFB6C1"
              opacity="0.3"
            />
          </motion.g>
          ...
          {isSleeping && (
            <motion.g
              ...
              transition={{ duration: 0.5 }}
            >
              <text x="130" y="25" fontSize="16" fill="#A78BFA" opacity="0.6">
                💤
              </text>
              <text x="145" y="20" fontSize="10" fill="#A78BFA" opacity="0.4">
                Z
              </text>
              <text x="155" y="15" fontSize="8" fill="#A78BFA" opacity="0.3">
                z
              </text>
            </motion.g>
          )}
